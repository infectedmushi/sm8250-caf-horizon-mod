...
static unsigned int default_efficient_freq_hp[] = {1286400, 1670400, 2054400};
static u64 default_up_delay_hp[] = {10 * NSEC_PER_MSEC, 20 * NSEC_PER_MSEC, 470 * NSEC_PER_MSEC};

static unsigned int default_efficient_freq_pr[] = {1632000, 2073600, 2457600};
static u64 default_up_delay_pr[] = {10 * NSEC_PER_MSEC, 20 * NSEC_PER_MSEC, 470 * NSEC_PER_MSEC};
